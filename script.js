  ...
  if (id === "sabias1") {
    contenido.innerHTML = `
      ...
      <div style="display: flex; gap: 10px;">
        <img src="img/org1.jpg" width="48%" alt="Organización 1">
        <img src="img/org2.jpg" width="48%" alt="Organización 2">
      </div>
    `;
  } else if (id === "sabias2") {
    contenido.innerHTML = `
      ...
      <div style="display: flex; gap: 10px;">
        <img src="img/dirigente1.jpg" width="48%" alt="Dirigente 1">
        <img src="img/dirigente2.jpg" width="48%" alt="Dirigente 2">
      </div>
    `;
  } else if (id === "sabias3") {
    contenido.innerHTML = `
      ...
      <div style="display: flex; gap: 10px;">
        <img src="img/participacion1.jpg" width="48%" alt="Participación 1">
        <img src="img/participacion2.jpg" width="48%" alt="Participación 2">
      </div>
    `;
  }
}
